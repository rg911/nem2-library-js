...
describe('crypto tests', () => {
	...
	it('Can encrypt a private key', () => {
		...
		// Act:
		const result = Crypto.encodePrivKey(privateKey, password);
	...
	describe('Encrypt private key edge-cases', () => {
		it('Encryption throw error if no password', () => {
			...
			// Act:
			const result = Crypto.encodePrivKey.bind(null, privateKey, password);
	...
	describe('Encode & decode message edge-cases', () => {
		...
		it('Message decoding throw error if no recipient private key', () => {
			...
			const recipientPriv = '';
			const message = 'NEM is awesome !';
			const encryptedMessage = 'dd31d6b4111c1023bae6533399e74f73a29c6e6b48ab550f8a7bea127e27dddb4fd3fe4fad3c835307c0da52d9c268f56237d1810e07912e6a6568cba09d9a9176ee6b1ade9569c2e1e273e9675bd4ff';
