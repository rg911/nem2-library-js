...
* @version 0.7.15
*/
export default class MosaicDefinitionTransactionDTO {
    /**
    ...
    */
    ...
    constructor(signature, signer, version, type, maxFee, deadline, mosaicNonce, mosaicId, properties) {
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            TransactionDTO.constructFromObject(data, obj);MosaicDefinitionTransactionBodyDTO.constructFromObject(data, obj);
