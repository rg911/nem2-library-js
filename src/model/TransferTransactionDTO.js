...
* @version 0.7.15
*/
export default class TransferTransactionDTO {
    /**
    ...
    */
    ...
    constructor(signature, signer, version, type, maxFee, deadline, recipient, mosaics, message) {
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            TransactionDTO.constructFromObject(data, obj);TransferTransactionBodyDTO.constructFromObject(data, obj);
