...
* @version 0.7.15
*/
export default class EmbeddedSecretProofTransactionDTO {
    /**
    ...
    */
    ...
    constructor(signer, version, type, maxFee, deadline, hashAlgorithm, secret, proof) {
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            EmbeddedTransactionDTO.constructFromObject(data, obj);SecretProofTransactionBodyDTO.constructFromObject(data, obj);
