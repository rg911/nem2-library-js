...
export default class NodeInfoDTO {
    ...
    */
    ...
    constructor(publicKey, port, networkIdentifier, version, roles, host, friendlyName) {
        ...
        NodeInfoDTO.initialize(this, publicKey, port, networkIdentifier, version, roles, host, friendlyName);
    }
     ...
     */
    static initialize(obj, publicKey, port, networkIdentifier, version, roles, host, friendlyName) { 
        obj['publicKey'] = publicKey;
        obj['port'] = port;
        obj['networkIdentifier'] = networkIdentifier;
        obj['version'] = version;
        obj['roles'] = roles;
        obj['host'] = host;
 ...
 * @member {String} publicKey
 */
NodeInfoDTO.prototype['publicKey'] = undefined;

/**
 * The port used for the communication.
 * @member {Number} port
 */
NodeInfoDTO.prototype['port'] = undefined;

/**
 * @member {Number} networkIdentifier
 */
NodeInfoDTO.prototype['networkIdentifier'] = undefined;

/**
 * The version of the application.
 * @member {Number} version
 */
NodeInfoDTO.prototype['version'] = undefined;

/**
 * @member {module:model/RolesEnum} roles
 */
NodeInfoDTO.prototype['roles'] = undefined;

/**
 * The IP address of the endpoint.
 * @member {String} host
 */
NodeInfoDTO.prototype['host'] = undefined;

/**
 * The name of the node.
 * @member {String} friendlyName
 */
NodeInfoDTO.prototype['friendlyName'] = undefined;
